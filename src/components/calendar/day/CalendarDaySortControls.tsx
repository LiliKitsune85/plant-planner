...
import type { CalendarDayOrderOption, CalendarDaySortOption } from "@/lib/services/calendar/day-view-model";

interface CalendarDaySortControlsProps {
  sortOptions: CalendarDaySortOption[];
  orderOptions: CalendarDayOrderOption[];
}

export const CalendarDaySortControls = ({ sortOptions, orderOptions }: CalendarDaySortControlsProps) => (
