...
export interface PlantDetailErrorStateProps {
...
export const PlantDetailErrorState: FC<PlantDetailErrorStateProps> = ({ error, onRetry, loginHref, backHref }) => {
  ...
  return (
    <Card role="alert">
      ...
      <CardContent className="space-y-4">
        ...
        {error.requestId ? <p className="text-xs text-muted-foreground/80">ID żądania: {error.requestId}</p> : null}
