...
export interface TasksRegeneratedSummaryCardProps {
  ...
  return (
    <Card className="border-primary/30 bg-primary/5">
      <CardHeader>
        ...
        <CardDescription>
          Zregenerowaliśmy zadania w zakresie {formatIsoDate(summary.from)} – {formatIsoDate(summary.to)} (łącznie{" "}
          {summary.count}).
        </CardDescription>
      </CardHeader>
      <CardContent className="text-sm text-muted-foreground">
        <p>Po chwili zostaniesz przeniesiony do kalendarza, aby zobaczyć zaktualizowany harmonogram.</p>
      </CardContent>
    </Card>
  );
};
