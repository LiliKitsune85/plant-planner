import type { DeletePlantMutationErrorVm, PlantDeleteErrorVm, PlantDeleteVm } from "@/components/plants/delete/types";
...
export const mapPlantsApiErrorToDeletePlantMutationErrorVm = (error: PlantsApiError): DeletePlantMutationErrorVm => ({
  kind: error.kind,
