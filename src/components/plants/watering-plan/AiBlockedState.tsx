    ...
    <Card className="border-amber-500/40 bg-amber-500/5">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          Możesz kontynuować konfigurację planu ręcznie. Proponowany plan AI zostanie zapisany, gdy limit zostanie
          odblokowany i spróbujesz ponownie.
        </p>
        {quota ? (
          <dl className="mt-4 space-y-1 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4 text-sm text-amber-900">
            ...
            <div className="flex justify-between gap-4">
              ...
              <dd className="font-semibold text-amber-950">{formatDateTime(quota.window_resets_at)}</dd>
            </div>
          </dl>
        ) : null}
      </CardContent>
