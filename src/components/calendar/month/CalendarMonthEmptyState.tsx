...
type CalendarMonthEmptyStateProps = {
  ctaHref: string
  status: CalendarTaskStatusFilter
}

export const CalendarMonthEmptyState = ({
  ctaHref,
  status,
}: CalendarMonthEmptyStateProps) => (
  <Card className="text-center">
    <CardHeader>
      <CardTitle>Brak zadań w tym miesiącu</CardTitle>
      <CardDescription>
        Nie zaplanowano {CALENDAR_STATUS_LABELS[status].toLowerCase()} w wybranym miesiącu.
        Dodaj roślinę, aby
        rozpocząć harmonogram podlewania.
      </CardDescription>
    </CardHeader>
    <CardContent />
