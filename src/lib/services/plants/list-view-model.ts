...
export const normalizePlantsListSort = (
  value?: PlantSortField | string | null,
): PlantSortField => {
...
export const normalizePlantsListSearch = (value?: string | null): string | undefined =>
  normalizeTextFilter(value)

export const normalizePlantsListSpecies = (value?: string | null): string | undefined =>
  normalizeTextFilter(value)

export const normalizePlantsListQueryState = (
  value: PlantsListQueryState,
): PlantsListQueryState => ({
...
export const arePlantsListQueriesEqual = (
  a: PlantsListQueryState,
  b: PlantsListQueryState,
): boolean =>
  a.q === b.q &&
  a.species === b.species &&
  a.sort === b.sort &&
...
export const getPlantsListCacheKey = (query: PlantsListQueryState): string => {
  ...
  return [
    normalizeKeyPart(query.q),
    normalizeKeyPart(query.species),
    query.sort,
    query.order,
    query.limit,
  ].join('|')
...
export const buildPlantsListErrorVmFromApiError = (
...
export const buildUnknownPlantsListErrorVm = (
  message = 'Nie udało się wczytać listy roślin.',
): PlantsListErrorVm => ({
  kind: 'unknown',
  message,
})
