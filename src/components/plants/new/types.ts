...
export type CreatePlantFormValues = {
  species_name: string
  nickname: string
  description: string
...
export type CreatePlantFormErrors = {
...
export type CreatePlantErrorVm = {
...
export type AiRateLimitVm = {
  isRateLimited: boolean
  unlockAt?: string | null
}

export type CreatePlantAiToggleVm = {
  enabled: boolean
  isRateLimited: boolean
  unlockAt?: string | null
