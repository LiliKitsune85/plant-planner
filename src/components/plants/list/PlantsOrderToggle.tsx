...
const ORDER_OPTIONS: { value: SortOrder; label: string; symbol: string }[] = [
  { value: "asc", label: "Rosnąco", symbol: "↑" },
  { value: "desc", label: "Malejąco", symbol: "↓" },
];

interface PlantsOrderToggleProps {
  value: SortOrder;
  disabled?: boolean;
  onChange: (next: SortOrder) => void;
}

export const PlantsOrderToggle = ({ value, disabled = false, onChange }: PlantsOrderToggleProps) => {
  return (
