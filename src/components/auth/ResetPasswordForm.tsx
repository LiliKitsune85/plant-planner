...
export const ResetPasswordForm = () => {
  ...
  return (
    <form className="space-y-5" onSubmit={onSubmit} noValidate>
      {errors.form ? (
        <AuthErrorAlert title="Nie udało się ustawić hasła" description={errors.form} />
      ) : null}
      ...
      {successMessage ? (
        ...
        >
          <p className="text-sm text-emerald-900/80">
            Po wdrożeniu backendu sesja odzyskiwania zostanie zamknięta, a my poprosimy Cię o ponowne
            zalogowanie.
          </p>
        </AuthNotice>
      ) : null}
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          aria-describedby={
            fieldErrors.confirmPassword?.length ? 'reset-password-confirm-errors' : undefined
          }
          disabled={isSubmitting}
        />
