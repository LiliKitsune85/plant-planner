...
const toInternalCursor = (
  payload: WateringPlanHistoryCursorPayload,
...
export const decodeWateringPlanHistoryCursor = (raw: string): WateringPlanHistoryCursor => {
  ...
  try {
    ...
    console.error('Failed to base64url decode watering plan cursor', { error })
  ...
  try {
    ...
    console.error('Failed to parse watering plan cursor JSON', { error })
...
export const encodeWateringPlanHistoryCursor = (
