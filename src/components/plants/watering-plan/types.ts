...
export interface AiSuggestionAvailableVm {
  status: "available";
  aiRequestId: string;
  intervalDays: number;
  horizonDays: number;
...
export interface AiSuggestionRateLimitedVm {
  status: "rate_limited";
  unlockAt?: string | null;
  aiRequestId?: string | null;
}

export interface AiSuggestionErrorVm {
...
export interface AiSuggestionSkippedVm {
  status: "skipped";
  reason?: string | null;
}
...
export interface WateringPlanFormValues {
...
export interface SetPlanErrorVm {
