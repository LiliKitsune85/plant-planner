...
export const CreatePlantForm = ({
  ...
  const handleInputChange = useCallback(
    (field: keyof CreatePlantFormValues) => (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit} noValidate>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            aria-describedby={fieldErrors.species_name?.length ? buildErrorId("species_name") : undefined}
            required
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            disabled={isSubmitting}
          />
          <p className="text-sm text-muted-foreground">{FIELD_DESCRIPTORS.purchase_date.description}</p>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
        <Button type="button" variant="outline" onClick={onCancel} disabled={isSubmitting} className="sm:min-w-[160px]">
          Anuluj
        </Button>
        <Button
          type="submit"
