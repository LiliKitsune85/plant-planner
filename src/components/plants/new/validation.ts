...
const mapIssuePathToField = (path: Array<string | number> | undefined): CreatePlantFormField => {
...
export const mergeFieldErrorsFromDetails = (
  existing: CreatePlantFormErrors['fieldErrors'],
  details: unknown,
) => {
